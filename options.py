...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--class-name', type=str, default='suitcase',
        ...
        self.parser.add_argument('--dataset', type=str, default='train',
        ...
        self.parser.add_argument('--checkpoints-dir', type=str, default='checkpoints_my',
